            ...
            <div class="box-manage-job-posting">
                <div class="heading-manage">
                    <div class="left-heading">
                        ...
                        <div><a href="{{ route('employer.view_postJob') }}">
                ...
                <div class="main-tabslet">
                    <ul class="tabslet-tab">
                        <li class="tablinks active" data-electronic="tab-dd">
                            <a href="#">Việc Làm Đang Đăng</a>
                        </li>
                        <li class="tablinks" data-electronic="tab-cd">
                            <a href="#">Việc Làm Chờ Đăng</a>
                        </li>
                        <li class="tablinks" data-electronic="tab-hh">
                            <a href="#">Việc Làm Hết Hạn</a>
                        </li>
                    </ul>
                    ...
                    <div class="tabslet-content" id="tab-cd">
                        <div class="main-jobs-posting">
                            <div class="heading-jobs-posting">
                                <div class="left-heading">
                                    <p class="name">Hiển thị </p>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <ul class="list-manipulation">
                                                        ...
                                                        <li>
                                                            <a href="https://careerbuilder.vn/vi/employers/hrcentral/viewjob/35BE100A/user_id/nhavophong3.1697429348/sort/desc/type/3/position/1"
                                                               title="Chi tiết"><em
                                                                    class="material-icons">visibility </em></a></li>
                                                        <li>
                                                            <a href="https://careerbuilder.vn/vi/employers/hrcentral/posting/copyjob/nhavophong3.1697429348/35BE100A/1/1"
                                                               title="Nhân bản"><em
                                                                    class="material-icons">content_copy </em> </a></li>

                                                        <li>
                                                            <a href="https://careerbuilder.vn/vi/employers/postjobs/35BE100A"
                                                               title="Sửa"><em class="material-icons">created</em></a>
                                                        </li>
                    ...
                    <div class="tabslet-content" id="tab-hh">
                        <div class="main-jobs-posting">
                            <div class="heading-jobs-posting">
                                <div class="left-heading">
                                    <p class="name">Hiển thị </p>
