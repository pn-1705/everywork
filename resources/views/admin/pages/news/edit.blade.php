...
@section('adminTitle', 'Chỉnh sửa bài viết')
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <textarea name="noidung" class="form-control" id="ckeditor_noidung_news"
                                          placeholder="Nội dung bài viết">{{ $new -> noidung }}</textarea>
                            </div>
                            <div class="form-check">
                                <input name="hienthi" type="checkbox" class="form-check-input" id="exampleCheck1" @if($new->hienthi == 1)checked @endif>
                                <label class="form-check-label" for="exampleCheck1">Hiển thị</label>
                            </div>
                            <div class="form-check">
                                <input name="noibat" type="checkbox" class="form-check-input" id="exampleCheck2" @if($new->noibat == 1)checked @endif>
