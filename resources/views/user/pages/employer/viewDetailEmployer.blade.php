    ...
    <section class="jobsby-company cb-section">
        <div class="container">
            <div class="company-introduction">
                ...
                <div class="company-follow"><span id="totalFollowers" class="follower-number"><strong
                            id="countFollowers">951 </strong>
          followers</span>
                    <div class="btn-follow  icon-follow"><a class="btn-gradient" href="javascript:void(0);"
                                                            id="follow_act" rel="1" title="Follow"><em
            ...
            <div class="main-company-photo">
                ...
                <div class="swiper-container swiper-container-initialized swiper-container-horizontal">
                    <div class="swiper-wrapper"
                        ...
                        <div class="swiper-slide swiper-slide-active" style="width: 348px; margin-right: 6px;">
                            <div class="album"><a
                                    href="https://images.careerbuilder.vn/employer_photo/4777/15-05-2014_9-03_am_1400118982.jpg"
                                    data-fancybox="album-2"><img class="swiper-lazy swiper-lazy-loaded" alt=""
                                                                 src="https://images.careerbuilder.vn/employer_photo/4777/15-05-2014_9-03_am_1400118982.jpg"></a>

                            </div>
                        </div>
                        <div class="swiper-slide swiper-slide-next" style="width: 348px; margin-right: 6px;">
                            <div class="album"><a
                                    href="https://images.careerbuilder.vn/employer_photo/4777/28459af58cc1759f2cd0_1653474813.jpg"
                                    data-fancybox="album-2"><img class="swiper-lazy swiper-lazy-loaded" alt=""
                                                                 src="https://images.careerbuilder.vn/employer_photo/4777/28459af58cc1759f2cd0_1653474813.jpg"></a>

                            </div>
                        </div>
                        <div class="swiper-slide" style="width: 348px; margin-right: 6px;">
                            <div class="album"><a
                                    href="https://images.careerbuilder.vn/employer_photo/4777/aw7a7252-1_1653474853.jpg"
                                    data-fancybox="album-2"><img class="swiper-lazy swiper-lazy-loaded" alt=""
                                                                 src="https://images.careerbuilder.vn/employer_photo/4777/aw7a7252-1_1653474853.jpg"></a>

                            </div>
                        </div>
                        <div class="swiper-slide" style="width: 348px; margin-right: 6px;">
                            <div class="album"><a
                                    href="https://images.careerbuilder.vn/employer_photo/4777/khanh-thanh-nha-may-dien-mat-troi-solar-farm-nhon-hai_1653474904.jpg"
                                    data-fancybox="album-2"><img class="swiper-lazy swiper-lazy-loaded" alt=""
                                                                 src="https://images.careerbuilder.vn/employer_photo/4777/khanh-thanh-nha-may-dien-mat-troi-solar-farm-nhon-hai_1653474904.jpg"></a>
                ...
                <div class="swiper-navigation">
                    <div class="swiper-prev swiper-nav swiper-button-disabled swiper-button-lock" tabindex="0"
                         role="button" aria-label="Previous slide" aria-disabled="true"><span
                            class="mdi mdi-chevron-left"></span></div>
                    <div class="swiper-next swiper-nav swiper-button-disabled swiper-button-lock" tabindex="0"
                         role="button" aria-label="Next slide" aria-disabled="true"><span
            ...
            <div class="company-jobs-opening">
                                    ...
                                    <div class="advanced-search">
                                        <div class="form-group form-keyword">
                                            <input type="search" class="keyword" name="keyword" id="keyword"
                                                   placeholder="Chức danh, Kỹ năng, Tên công ty" autocomplete="off">
                                        </div>
                                        ...
                                        <div class="form-group form-select-chosen">
                                            ...
                                            <div class="chosen-container chosen-container-multi" title=""
                                                 id="location_chosen" style="width: 446px;">
                                                <ul class="chosen-choices">
                                                    <li class="search-field">
                                                        <input class="chosen-search-input default" type="search"
                                                               autocomplete="off" value="Tất cả địa điểm"
                                                               style="width: 120.713px;">
                                                    </li>
                                                </ul>
                                                <div class="chosen-drop">
                                                    <ul class="chosen-results"></ul>
                                        ...
                                        <div class="form-group find-jobs">
                                            <button class="btn-gradient" onclick="return validataSearchJobEmp('vi');">
                                                <p>Tìm Ngay</p>
                ...
                <input type="hidden" value="35A4FBA9" name="emp_id" id="emp_id">
                <input type="hidden" value="cong-ty-cp-lizen" name="emp_name" id="emp_name">
                <div class="list-job">
