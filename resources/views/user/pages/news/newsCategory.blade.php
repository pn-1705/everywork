...
@section('pageTitle', $nameCate )

@include('user.elements.news-heading-tool')

@section('content')

    <section class="cb-career-advice-category cb-section">
        <div class="container">
            <div class="row">
                    ...
                    <div class="box-news">
                        <div class="row">
                            @foreach($listNews as $news)
                                <div class="col-sm-6 col-md-4 col-lg-6 col-xl-4 item">
                                    <div class="figure">
                                        <div class="image"><a
                                                href="{{ route('user.viewNewDetail', $news -> tieudekhongdau) }}">
                                                <img src="{{ asset('public/imgs/news/'. $news -> hinhanh) }}"
                                                     class="lazy-bg" style=""></a></div>
                                        <div class="figcaption">
                                            ...
                                            <div class="content"> {!! $news -> noidung !!} </div>
                                            <div class="view-more">
                                                <a href="{{ route('user.viewNewDetail', $news -> tieudekhongdau) }}"
                                                   title="Cách Viết Mẫu CV Dịch Vụ Khách Hàng Chuẩn Form Và Thu Hút Nhất">Xem
