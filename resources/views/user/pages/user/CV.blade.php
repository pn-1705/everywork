                    ...
                    <div class="widget widget-10">
                        <div class="widget-head">
                            <div class="cb-title-h3">
                                ...
                                <a onclick="openFormApply()" class="create-button create-resume btn font-weight-bold ml-auto p-0">
                                    <i class="bi bi-plus-circle"></i> Tải lên hồ sơ mới
                                </a>
                            </div>
                        </div>
                        <div class="widget-body">
                            <div class="content">
                                <p>Bạn được tạo tối đa 6 hồ sơ, trong đó chỉ có hồ sơ mặc định được cho phép tìm kiếm.
                                    Các hồ sơ khác có thể dùng để ứng tuyển.</p>
                            </div>
                            <div class="table">
                                    <table>
                                        <tbody>
                                            ...
                                            <tr>
                                                <td class="job">
                                                    <div class="name">
                                                        <div class="figure">
                                                            <div class="image">
                                                                <a alt="{{ asset('public/CV/'. $cv -> fileCV) }}">

                                                                    <embed src="{{ asset('public/CV/'. $cv -> fileCV) }}" type="application/pdf">
                                                ...
                                                <td class="date">
                                                    <p class="mb-show">Tải lên: </p>
                                                    <time> {{ $cv -> updated_at }}</time>
                                                </td>

                                                <td class="action">

                                                    <ul class="list-action">
                                                        <li class=""><a class="" href="{{ route('xoa-CV', $cv -> idCV) }}">
                                                                <em class="material-icons alert-danger">delete</em></a>
                                                        </li>
                                                    </ul>
                                                </td>
                                            </tr>
                ...
                <div class="modal-content">
                    <div class="modal-header d-flex align-items-center px-lg-4 bg-light">
                        <div class="modal-title text-truncate h5" id="applyModalLabel"><span
                                class="font-weight-normal mr-2">Tải lên hồ sơ mới</span>
                        </div>
                    ...
                    <div class="modal-body p-lg-4">
                        <form enctype="multipart/form-data" method="post" class="container-0-2-5" action="{{ route('tai-len-ho-so') }}">
                            @csrf
                            <div class="dnd-upload-container">
                                <div><input accept=".pdf,.doc,.docx,.xls" type="file" class="d-none" value="">
                                    <div>
                                        <div class="fileButtonContainer-0-2-6 px-4 py-4"><i
                                                class="d-block cli-file-upload text-primary"></i>
                                            ...
                                            <label for="fileCV"
                                                   ...
                                                   type="button"><i class="bi bi-upload"></i> Tải lên
                                            </label>
                                            ...
                                            <button
                                                   class="btn rounded-pill mt-2 border-primary font-weight-bold w-100"
                                                   type="submit"><i class="bi bi-floppy"></i> Lưu
                                            </button>
                                            <p class="mt-2 mb-0 text-muted">File: doc, docx, xls, pdf (tối đa 3MB)</p>
                                            <p class="mt-0 mb-0 text-muted">Vui lòng không chọn file hình ảnh, bằng cấp</p></div>
                                    </div>
