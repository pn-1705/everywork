...
@section('pageTitle', 'Quản lí hồ sơ')
        ...
        <div class="content-inner">
            <div class="container-fluid">
                <div class="my-account-wrap">
                    ...
                    <div class="row">
                        <div class="edit-db-infor fancybox-content" style="">
                            @if(session('succes'))
                            ...
                            <div class="modal-body">
                                <form action="{{ route('update_information') }}" enctype="multipart/form-data"
                                      method="post">
                                    @csrf
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <script type="text/javascript">
                                                    window.onload = function () {
                                                        const input_avt = document.getElementById('fileAvatar');
                                            ...
                                            <div class="form-radio d-flex">
                                                ...
                                                <div style="margin-left: 100px;" class="gender">
                                                    ...
                                                    <input @if(Auth::user()->gioitinh == 1)
                                                           checked
                                                           @endif style="margin-left: 20px;" type="radio" id="gender_f"
                                                           value="1"
                                                           name="gioitinh">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <select name="city" id="slcity">
                                                    <?php $city = \App\Models\City::all() ?>
                                                    @foreach($city as $list)
                                                        <option {{Auth::user()->city == $list -> id ? 'selected' : ""}}
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group form-text">
                                                <input type="number" onkeyup="this.setAttribute('value', this.value);"
                                                       name="phone" id="mobile" value="{{Auth::user()->phone}}"
                                                       maxlength="10"
                                                       style="margin-top:5px">
