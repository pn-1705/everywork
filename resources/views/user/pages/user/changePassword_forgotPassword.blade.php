...
@section('content')
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="main-form">
                            <div class="form-reset-password">
                                <form class="form-horizontal" id="frmPassowrd" name="frmPassowrd" method="post" action="{{ route('user.forgotpassword.change') }}">
                                   @csrf
                                    <input type="hidden" name="code" value="bmhhdm9waG9uZzNfZ21haWwuY29tXzIwMjMwOTI2MDkyNTUyOjpka3E0djk=">
                                    <div class="form-group form-text toggle-password">
                                        <input type="password" name="new_password" id="new_password" maxlength="255" onkeyup="this.setAttribute('value', this.value);" value="">
                                        <label for="">*  Mật khẩu mới</label>
                                        <span class="error_new_password"></span>
                                        @error('new_password')
                                        <span class="error_new_password">{{ $message }}</span>
                                        @enderror
                                    ...
                                    <div class="form-group form-text toggle-password">
                                        ...
                                        <span class="error_confirm_password">{{ $message }}</span>
                                        @enderror
                                        <div class="showhide-password eyess"></div>
                                    </div>
                                    <input value="{{$code}}" name="code" hidden type="text">
    ...
    <style>
        ...
        .information .list-info .job-item {
            margin-bottom: 20px;
        }

        .information .list-info .image {
            -webkit-box-pack: center;
            -ms-flex-pack: center;
            -webkit-box-align: center;
            -ms-flex-align: center;
        ...
        .information .list-info .image.is-blue {
            background: #2f4ba0;
        }

        .information .list-info .image.is-green {
            background: #88c444;
        }

        .information .list-info .image.is-yellow {
            background: #fcb616;
        }
        ...
        .information .list-info .title h3 {
            color: #172642;
            font-size: 18px;
            font-weight: 700;
            text-align: center;
        ...
        .information .list-info .caption p {
            color: #5d677a;
            font-size: 16px;
            font-weight: 500;
            text-align: center;
        ...
        @media (min-width: 1025px) {
            ...
            .information .list-info .figcaption {
                -webkit-box-flex: 0;
        ...
        .main-form .list-tabs li.active a, .main-form .list-tabs li:hover a {
            text-decoration: none;
        }

        .main-form .list-tabs li.active:before, .main-form .list-tabs li:hover:before {
            width: 100%;
        }
        ...
        .main-form .choose-follow ul li a, .main-form .choose-follow ul li button {
        ...
        .main-form .choose-follow ul li a em, .main-form .choose-follow ul li button em {
            font-size: 18px;
            font-weight: 500;
        }

        .main-form .choose-follow ul li a:before, .main-form .choose-follow ul li button:before {
        ...
        .main-form .choose-follow ul li a:focus, .main-form .choose-follow ul li button:focus {
            outline: none;
        }

        .main-form .choose-follow ul li a.fb, .main-form .choose-follow ul li button.fb {
            background: #3b5998;
        }

        .main-form .choose-follow ul li a.gg, .main-form .choose-follow ul li button.gg {
            background: #dd4b39;
        }

        .main-form .choose-follow ul li a.gg:before, .main-form .choose-follow ul li button.gg:before {
            left: 51px;
            background: #e26657;
        }

        .main-form .choose-follow ul li a:hover, .main-form .choose-follow ul li button:hover {
            text-decoration: none;
        }
        ...
        @media (min-width: 1025px) {
            ...
            .main-form .choose-follow ul li button {
                -webkit-transition: 0.4s ease-in-out all;
                -o-transition: 0.4s ease-in-out all;
                transition: 0.4s ease-in-out all;
            }

            .main-form .choose-follow ul li button:hover {
        ...
        .main-form .forgot-password a:hover {
        ...
        @media (min-width: 1025px) {
            ...
            .main-form .form-login .form-group {
                margin-bottom: 25px;
            }
        }

        .signin-form .box-shadown {
            -webkit-box-shadow: 0 0 10px 0 rgba(0, 0, 0, 0.1);
            box-shadow: 0 0 10px 0 rgba(0, 0, 0, 0.1);
        }

        .signin-form .box-shadown .row > * {
            margin-bottom: 0;
        }
        ...
        @media (min-width: 1025px) {
            ...
            .signin-form .box-shadown .col-md-6 {
                padding: 0;
            }

            .signin-form .box-shadown .information {
                height: 100%;
