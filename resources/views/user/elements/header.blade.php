    ...
    <div class="container d-flex align-items-center justify-content-between">
        ...
        <nav id="navbar" class="navbar">
            <ul>
                ...
                {{--                </li>--}}
                {{--                <span>|</span>--}}
                <li style="white-space: nowrap;padding: 10px 0 10px 10px;" class="dropdown"><a
                        class="{{ Route::is('information') ? 'active' : '' }}"
                        href="{{ route('user.pages.login_page') }}"><span class="bi bi-person"></span> &nbsp;
                        <?php
                        //                        $info = Auth::user()->ten;
                        ...
                        >
                            ...
                            @if(Auth::user()->id_nhomquyen == 1)
                                <li><a href="{{ route('information') }}"><span class="bi bi-person-bounding-box"> &nbsp; Thông tin công ty</span></a>
                                </li>
