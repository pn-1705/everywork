                                    ...
                                    <select name="salary" id="salary" class="select-custom select-custom-nosearch"
                                        ...
                                        <option
                                            @if(isset($salary))
                                                ...
                                                selected
                                                @endif
                                            @endif value=3000000>Từ 3.000.000 đ</option>
                                        <option
                                            @if(isset($salary))
                                            @if($salary == 5000000)
                                            selected
                                            @endif
                                            @endif
                                            value=5000000>Từ 5.000.000 đ</option>
                                        <option
                                            @if(isset($salary))
                                                @if($salary == 7000000)
                                                selected
                                                @endif
                                            @endif
                                                value=7000000>Từ 7.000.000 đ</option>
                                        <option
                                            @if(isset($salary))
                                                @if($salary == 10000000)
                                                selected
                                                @endif
                                            @endif
                                                value=10000000>Từ 10.000.000 đ</option>
                                        <option
                                            @if(isset($salary))
                                            @if($salary == 15000000)
                                            selected
                                            @endif
                                            @endif value=15000000>Từ 15.000.000 đ</option>
                                        <option
                                            @if(isset($salary))
                                            @if($salary == 20000000)
                                            selected
                                            @endif
                                            @endif value=20000000>Từ 20.000.000 đ</option>
                                        <option
                                            @if(isset($salary))
                                            @if($salary == 30000000)
                                            selected
                                            @endif
                                            @endif value=30000000>Từ 30.000.000 đ</option>
                                        <option
                                            @if(isset($salary))
                                            @if($salary == 40000000)
                                            selected
                                            @endif
                                            @endif value=40000000>Từ 40.000.000 đ</option>
                                        <option
                                            @if(isset($salary))
                                            @if($salary == 50000000)
                                            selected
                                            @endif
                                            @endif value=50000000>Từ 50.000.000 đ</option>
                                        <option
                                            @if(isset($salary))
                                            @if($salary == 60000000)
                                            selected
                                            @endif
                                            @endif value=60000000>Từ 60.000.000 đ</option>
                                        <option
                                            @if(isset($salary))
                                            @if($salary == 70000000)
                                            selected
                                            @endif
                                            @endif value=70000000>Từ 70.000.000 đ</option>
...
<script>/*jskcommon.js*/
    ...
    $(document).on("click",".btn-close-modal",function(){$.fancybox.close();});function show_noti(type,content,more_link,icon,multi){if(type==1){var class_type='success-modal';if(typeof(content)==="undefined")content=language.popup_msg_success;}else{var class_type='remove-modal';if(typeof(content)==="undefined")content=language.popup_msg_error;}
        ...
        if(txt_multi==0)
            $.fancybox.close('all');var html_popup='<div class="'+class_type+'"><div class="modal-title"><p>'+language.title_popup+'</p></div><div class="modal-body"><div class="icon"><img src="'+txt_icon+'" alt=""></div><p>'+content+'</p>'+more_link+'<a class="btn-close-modal" href="javascript:void(0);">'+language.popup_close_popup+'</a></div></div>';$.fancybox.open(html_popup);}
    ...
    $(document).ready(function(){$.validator.addMethod('isemail',function(value,element){var valemail=$.trim(value);return checkEmail(valemail);},language.message_common);if(is_mobile==1){$("a[target=\"_blank\"]").removeAttr("target");}
        ...
        fncShowHidePassword();loadboxtopnoti();});$(".lazy-bg, img.lazy-img").lazy();function fncShowHidePassword(){if($(".showhide-password").length){$(".showhide-password").on('click',function(e){e.preventDefault();let objBtn=$(this);let objInputPassword=objBtn.closest('div.form-group').find('input');if(objInputPassword.attr('type')=='password'){objInputPassword.attr('type','text');objBtn.addClass('show');}else{objInputPassword.attr('type','password')
