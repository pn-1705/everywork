...
!function (e, t) {
    ...
    var u = "CardWidget", c = "lte.cardwidget", h = n.default.fn[u], g = "card", p = "collapsed-card",
        ...
        y = '[data-card-widget="remove"]', w = '[data-card-widget="collapse"]', C = '[data-card-widget="maximize"]',
        x = {
    ...
    var T = "ControlSidebar", S = "lte.controlsidebar", j = n.default.fn[T], k = ".control-sidebar",
        ...
        A = {
            ...
            var t = e.prototype;
            return t.collapse = function () {
                var e = this, t = n.default("body"), a = n.default("html"), i = this._config.target;
                this._config.controlsidebarSlide ? (a.addClass(E), t.removeClass(D).delay(300).queue((function () {
                    n.default(i).hide(), a.removeClass(E), n.default(this).dequeue()
                ...
                this._config.controlsidebarSlide ? (t.addClass(E), n.default(this._config.target).show().delay(10).queue((function () {
                    e.addClass(D).delay(300).queue((function () {
                        t.removeClass(E), n.default(this).dequeue()
                    })), n.default(this).dequeue()
                }))) : e.addClass(L), this._fixHeight(), this._fixScrollHeight(), n.default(this._element).trigger(n.default.Event("expanded.lte.controlsidebar"))
            }, t.toggle = function () {
    ...
    var de = "lte.iframe", fe = n.default.fn.IFrame, ue = '[data-widget="iframe"]',
        ...
        ye = be + " .tab-empty", we = be + " .tab-loading", Ce = be + " .tab-pane",
        ...
        Te = ".main-header a.dropdown-item", Se = "iframe-mode", je = "iframe-mode-fullscreen", ke = {
            ...
            return t.onTabClick = function (e) {
                ...
                var o = a.attr("href");
                if ("#" !== o && "" !== o && void 0 !== o) {
                    var l = o.replace("./", "").replace(/["#&'./:=?[\]]/gi, "-").replace(/(--)/gi, ""), s = "tab-" + l;
                ...
                if ("all" == e) n.default(ve).remove(), n.default(Ce).remove(), n.default(ye).show(); else if ("all-other" == e) n.default(ve + ":not(.active)").remove(), n.default(Ce + ":not(.active)").remove(); else if ("only-this" == e) {
                    var a = n.default(t), i = a.parent(".nav-item"), o = i.parent(), l = i.index(),
                        s = a.siblings(".nav-link").attr("aria-controls");
                    if (i.remove(), n.default("#" + s).remove(), n.default(be).children().length == n.default(ye + ", " + we).length) n.default(ye).show(); else {
                        var r = l - 1;
                        this.switchTab(o.children().eq(r).find("a.nav-link"))
                    }
                } else {
                    var d = n.default(ve + ".active"), f = d.parent(), u = d.index();
                    if (d.remove(), n.default(Ce + ".active").remove(), n.default(be).children().length == n.default(ye + ", " + we).length) n.default(ye).show(); else {
                        var c = u - 1;
                        this.switchTab(f.children().eq(c).find("a.nav-link"))
                    }
                }
            }, t.toggleFullscreen = function () {
                n.default("body").hasClass(je) ? (n.default(ce + " i").removeClass(this._config.iconMinimize).addClass(this._config.iconMaximize), n.default("body").removeClass(je), n.default(ye + ", " + we).height("100%"), n.default(he).height("100%"), n.default(ge).height("100%")) : (n.default(ce + " i").removeClass(this._config.iconMaximize).addClass(this._config.iconMinimize), n.default("body").addClass(je)), n.default(window).trigger("resize"), this._fixHeight(!0)
            }, t._init = function () {
    ...
    var He = "lte.layout", ze = n.default.fn.Layout, Fe = ".main-header", Ee = ".main-sidebar",
        Le = ".main-sidebar .sidebar", De = ".main-footer", Re = "sidebar-focused", Ae = {
            ...
            return t.fixLayoutHeight = function (e) {
                ...
                var i = {
                    window: n.default(window).height(),
                    header: n.default(Fe).length > 0 && !n.default("body").hasClass("layout-navbar-fixed") ? n.default(Fe).outerHeight() : 0,
    ...
    n.default(document).on("click", vt, (function (e) {
        ...
        "navbar-search" !== t.data("widget") && (t = t.closest(vt)), wt._jQueryInterface.call(t, "toggle")
    })), n.default.fn[gt] = wt._jQueryInterface, n.default.fn[gt].Constructor = wt, n.default.fn[gt].noConflict = function () {
        return n.default.fn[gt] = mt, wt._jQueryInterface
    };
    var Ct = n.default.fn.Toasts, xt = "topRight", It = "topLeft", Tt = "bottomRight", St = "bottomLeft", jt = {
        position: xt,
        fixed: !0,
        autohide: !1,
        autoremove: !0,
    ...
    }, e.CardRefresh = f, e.CardWidget = I, e.ControlSidebar = M, e.DirectChat = P, e.Dropdown = V, e.ExpandableTable = te, e.Fullscreen = re, e.IFrame = Qe, e.Layout = Me, e.NavbarSearch = wt, e.PushMenu = Ke, e.SidebarSearch = ht, e.Toasts = kt, e.TodoList = Lt, e.Treeview = $t, Object.defineProperty(e, "__esModule", {value: !0})
}));
